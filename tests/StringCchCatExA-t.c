...
void testDestEnd(){
    ...
    strcpy(dest, "foo");
    ok(SUCCEEDED(StringCchCatExA(dest, 11, "Data", &destEnd, NULL, 0)),
    ...
    ok(SUCCEEDED(StringCchCatExA(dest, 11, "", &destEnd, NULL, 0)),
            "Test calculation of destEnd "
    ...
    strcpy(dest, "TEST: ");
    ok(StringCchCatExA(dest, 11, "longer string", &destEnd, NULL, 0) ==
...
void testRemaining(){
    ...
    strcpy(dest, "Str");
    ok(SUCCEEDED(StringCchCatExA(dest, 11, "Safe", NULL, &remaining, 0)),
    ...
    ok(SUCCEEDED(StringCchCatExA(dest, 11, "", NULL, &remaining, 0)),
            "Test calculation of remaining space "
            "while appending an empty string.");
    is_string("StrSafe", dest,
            "Result of appending an empty string.");
    ...
    strcpy(dest, "TEST: ");
    ok(StringCchCatExA(dest, 11, "too long string", NULL, &remaining, 0) ==
            STRSAFE_E_INSUFFICIENT_BUFFER,
            "Test calculation of remaining space "
            "while appending a too long string.");
...
void testFlags(){
    ...
    strcpy(dest, "test");
    ok(SUCCEEDED(StringCchCatExA(dest, 11, NULL, NULL, NULL,
    ...
    strcpy(dest, "test");
    ok(SUCCEEDED(StringCchCatExA(dest, 11, "ing", NULL, NULL,
    ...
    strcpy(dest, "TEST: ");
    ok(FAILED(StringCchCatExA(dest, 11, "too much data", NULL, NULL,
    ...
    strcpy(dest, "data");
    ok(FAILED(StringCchCatExA(dest, 11, "Also too much", NULL, NULL,
    ...
    strcpy(dest, "data");
    ok(FAILED(StringCchCatExA(dest, 11, "Won't fit in dest", NULL, NULL,
...
int main(void){
    ...
    ok(SUCCEEDED(StringCchCatExA(dest, 11, "test", NULL, NULL, 0)),
