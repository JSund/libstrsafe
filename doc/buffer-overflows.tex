...
ending with a \define{NULL} character to signify the end of the string.
...
the \define{NULL} character is located.
...
the dynamically allocated memory in many \fn{malloc} implementations,
