...
void testDestEnd(){
	...
	wcscpy(dest, L"foo");
	ok(SUCCEEDED(StringCchCatExW(dest, 11, L"Data", &destEnd, NULL, 0)),
	...
	ok(SUCCEEDED(StringCchCatExW(dest, 11, L"", &destEnd, NULL, 0)),
			"Test calculation of destEnd "
	...
	wcscpy(dest, L"TEST: ");
	ok(StringCchCatExW(dest, 11, L"longer string", &destEnd, NULL, 0) ==
...
void testRemaining(){
	...
	wcscpy(dest, L"Str");
	ok(SUCCEEDED(StringCchCatExW(dest, 11, L"Safe", NULL, &remaining, 0)),
	...
	ok(SUCCEEDED(StringCchCatExW(dest, 11, L"", NULL, &remaining, 0)),
			"Test calculation of remaining space "
			"while appending an empty string.");
	is_wstring(L"StrSafe", dest,
			"Result of appending an empty string.");
	...
	wcscpy(dest, L"TEST: ");
	ok(StringCchCatExW(dest, 11, L"too long string", NULL, &remaining, 0) ==
			STRSAFE_E_INSUFFICIENT_BUFFER,
			"Test calculation of remaining space "
			"while appending a too long string.");
...
void testFlags(){
	...
	wcscpy(dest, L"test");
	ok(SUCCEEDED(StringCchCatExW(dest, 11, NULL, NULL, NULL,
	...
	ok(SUCCEEDED(StringCchCatExW(dest, 11, L"ing", NULL, NULL,
	...
	wcscpy(dest, L"TEST: ");
	ok(FAILED(StringCchCatExW(dest, 11, L"too much data", NULL, NULL,
	...
	wcscpy(dest, L"data");
	ok(FAILED(StringCchCatExW(dest, 11, L"Also too much", NULL, NULL,
	...
	wcscpy(dest, L"data");
	ok(FAILED(StringCchCatExW(dest, 11, L"Won't fit in dest", NULL, NULL,
...
int main(void){
	...
	ok(SUCCEEDED(StringCchCatExW(dest, 11, L"test", NULL, NULL, 0)),
