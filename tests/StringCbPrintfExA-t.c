...
void testDestEnd(){
    ...
    ok(SUCCEEDED(StringCbPrintfExA(dest, 11, &destEnd, NULL, 0, "Data")),
    ...
    ok(SUCCEEDED(StringCbPrintfExA(dest, 11, &destEnd, NULL, 0, "")),
            "Test calculation of destEnd "
    ...
    ok(StringCbPrintfExA(dest, 11, &destEnd, NULL, 0, "longer %s",
                "string") ==
...
void testRemaining(){
    ...
    ok(SUCCEEDED(StringCbPrintfExA(dest, 11, NULL, &remaining, 0, "STR")),
    ...
    ok(SUCCEEDED(StringCbPrintfExA(dest, 11, NULL, &remaining, 0, "")),
            "Test calculation of remaining space "
            "while printing empty string.");
    is_string("", dest,
            "Result of printing empty string.");
    ...
    ok(StringCbPrintfExA(dest, 11, NULL, &remaining, 0, "too long string")
            == STRSAFE_E_INSUFFICIENT_BUFFER,
            "Test calculation of remaining space "
            "while printing a too long string.");
...
void testFlags(){
    ...
    ok(SUCCEEDED(StringCbPrintfExA(dest, 11, NULL, NULL,
    ...
    ok(FAILED(StringCbPrintfExA(dest, 11, NULL, NULL,
...
int main(void){
    ...
    ok(SUCCEEDED(StringCbPrintfExA(dest, 11, NULL, NULL, 0, "test")),
