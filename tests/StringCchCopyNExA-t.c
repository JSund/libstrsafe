...
void testDestEnd(){
	...
	ok(SUCCEEDED(StringCchCopyNExA(dest, 11, "Data", 5, &destEnd, NULL, 0)),
	...
	ok(SUCCEEDED(StringCchCopyNExA(dest, 11, "", 1, &destEnd, NULL, 0)),
			"Test calculation of destEnd "
	...
	ok(StringCchCopyNExA(dest, 11, "longer string", 14, &destEnd, NULL, 0) ==
	...
	ok(SUCCEEDED(StringCchCopyNExA(dest, 11, "Another long string", 7,
					&destEnd, NULL, 0)),
			"Test calculation of destEnd "
...
void testRemaining(){
	...
	ok(SUCCEEDED(StringCchCopyNExA(dest, 11, "STR", 4, NULL, &remaining, 0)),
	...
	ok(SUCCEEDED(StringCchCopyNExA(dest, 11, "", 1, NULL, &remaining, 0)),
			"Test calculation of remaining space "
			"while copying empty string.");
	is_string("", dest,
			"Result of copying empty string.");
	...
	ok(StringCchCopyNExA(dest, 11, "too long string", 16,
				NULL, &remaining, 0) ==
			STRSAFE_E_INSUFFICIENT_BUFFER,
			"Test calculation of remaining space "
			"while copying a too long string.");
	...
	ok(SUCCEEDED(StringCchCopyNExA(dest, 11, "Foo bar baz", 7,
					NULL, &remaining, 0)),
			"Test calculation of remaining space "
			"while copying part of a string.");
...
void testFlags(){
	...
	ok(SUCCEEDED(StringCchCopyNExA(dest, 11, NULL, 0, NULL, NULL,
	...
	ok(SUCCEEDED(StringCchCopyNExA(dest, 11, "testing", 4, NULL, NULL,
	...
	ok(FAILED(StringCchCopyNExA(dest, 11, "too much data", 14, NULL, NULL,
	...
	ok(FAILED(StringCchCopyNExA(dest, 11, "Also too much", 14, NULL, NULL,
	...
	ok(FAILED(StringCchCopyNExA(dest, 11, "Won't fit in dest", 18, NULL, NULL,
...
int main(void){
	...
	ok(SUCCEEDED(StringCchCopyNExA(dest, 11, "test", 3, NULL, NULL, 0)),
