...
void testDestEnd(){
	...
	wcscpy(dest, L"foo");
	ok(SUCCEEDED(StringCbCatNExW(dest, 11 * sizeof(wchar_t),
	...
	wcscpy(dest, L"TEST: ");
	ok(StringCbCatNExW(dest, 11 * sizeof(wchar_t),
	...
	wcscpy(dest, L"Test: ");
	ok(SUCCEEDED(StringCbCatNExW(dest, 11 * sizeof(wchar_t),
					L"okay", 2 * sizeof(wchar_t), &destEnd, NULL, 0)),
			"Test calculation of destEnd "
...
void testRemaining(){
	...
	wcscpy(dest, L"Str");
	ok(SUCCEEDED(StringCbCatNExW(dest, 11 * sizeof(wchar_t),
					L"Safe", 5 * sizeof(wchar_t), NULL, &remaining, 0)),
...
void testFlags(){
	...
	wcscpy(dest, L"test");
	ok(SUCCEEDED(StringCbCatNExW(dest, 11 * sizeof(wchar_t),
					NULL, 10 * sizeof(wchar_t), NULL, NULL,
	...
	wcscpy(dest, L"test");
	ok(SUCCEEDED(StringCbCatNExW(dest, 11 * sizeof(wchar_t),
					L"ingenious", 3 * sizeof(wchar_t), NULL, NULL,
	...
	wcscpy(dest, L"TEST: ");
	ok(FAILED(StringCbCatNExW(dest, 11 * sizeof(wchar_t),
...
int main(void){
	...
	ok(SUCCEEDED(StringCbCatNExW(dest, 11 * sizeof(wchar_t),
					L"testing", 4 * sizeof(wchar_t), NULL, NULL, 0)),
